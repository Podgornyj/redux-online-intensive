...
describe("fetchUsers saga", () => {
    describe("should pass until response received", () => {
        ...
        test("should call a fetch request", () => {
            expect(saga.next().value).toEqual(apply(api, api.posts.users));
            clone = saga.clone();
        });
    });
    describe("should handle a 400 status response", () => {
        ...
        test('should dispatch "stopFetching" action', () => {
            expect(clone.next().value).toEqual(put(uiActions.stoptFetching()));
        });
        test("should finish", () => {
...
`);
        ...
        test('should dispatch "stoptFetching" action', () => {
